    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {filteredProducts.map((product) => (
          <article
            key={product.id}
            className="bg-slate-900/80 border border-white/5 rounded-2xl overflow-hidden flex flex-col"
          >
            ...
            <div className="flex-1 flex flex-col justify-between p-4 space-y-3">
              ...
              <button className="mt-2 w-full bg-white text-black py-2 rounded-md text-xs font-medium hover:bg-gray-200">
                Add to Cart
              </button>
            </div>
          </article>
